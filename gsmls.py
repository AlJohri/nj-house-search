...
def get_listings_summary(mlsnums):
...
if __name__ == "__main__":
    ...
    import json
    for listing in get_listings('Hudson', min_list_price='350000', max_list_price='500000', min_bedrooms='3', min_bathrooms='2'):
        print(json.dumps(listing))
    print()

    print("Viewing details of a single listing...")
